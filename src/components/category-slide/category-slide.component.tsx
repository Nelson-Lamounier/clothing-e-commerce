...
import {  SectionSlides,
    SlidesWrapper,} from "./category-slice.style"  
    ...
    return (
      <SectionSlides>
        <SlidesWrapper>
          ...
          <SlideCart slides={womenSlides} title="Women" categoryPath="/womencatalog" />
          <SlideCart slides={salesSlides} title="Sales" categoryPath="/salescatalog" />
        </SlidesWrapper>
      </SectionSlides>
    );
  };
